# # V2Ray Heroku
0822test ok 可以使用 加cf worker 。
记录：必须使用alterid，默认0.不能在配置中删除。
...
> [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/xiaokanhongchen/kuv2hero)
...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `` | VMess 用户主 ID，用于身份验证，为 UUID 格式 |
